...
class TokoJualResource(Resource):
    ...
    def post(self):
        ...
        parser.add_argument('jenis_bahan', location='json', required=True, help='bahan tidak terdaftar'
        ...
        if user.designer_status == True:
            ...
            barang = Barang(toko_id,args['nama_barang'], "Rp. {}".format(harga), harga, args['deskripsi'], args['jenis_bahan'], args['desain'])
    ...
    def get(self):
        ...
        if user.designer_status == True:
            ...
            if args['harga minimal'] is not None:
                list_barang = list_barang.filter(Barang.harga_int >= args['harga minimal'])
            if args['harga maksimal'] is not None:
                list_barang = list_barang.filter(Barang.harga_int <= args['harga maksimal'])
...
class ListTokoResource(Resource):
    def get(self):
        ...
        if args['search'] is not None:
            ...
            qry_toko = qry_toko.filter(Toko.nama.like(search) | Toko.deskripsi.like(search))
        # Orderby
        if args['orderby'] is not None:
        ...
        for toko in toko_limit:
            ...
            for barang in barang_toko:
                ...
                if barang_populer == "":
                    ...
                    barang_populer = marshal_barang
            marshal_toko['barang populer'] = barang_populer
